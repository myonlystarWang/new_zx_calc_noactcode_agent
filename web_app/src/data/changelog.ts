...
export const CHANGELOG: ChangelogEntry[] = [
    {
        version: '1.1.6',
        date: '2026-09-18',
        title: '方案支持粘贴导入；坏链接会给提示；小数不再被抹掉',
        changes: [
            { type: 'feat', text: '属性方案新增「导入」：手里有一份数据时，点「导入」把属性和增益数值直接粘贴进去，确认后自动存成方案并填好，不用一项一项手填' },
            { type: 'fix', text: '打开别人发的分享链接时，如果链接内容损坏（复制时被截断等），页面会明确提示"配置没能恢复"，不再悄无声息地只换职业阵营' },
            { type: 'fix', text: '对比窗口和各处数值显示保留小数：巫咒 22.5 不会再显示成 23' },
        ],
    },
    {
        version: '1.1.5',
